...
namespace Shadowsocks.View
{
    ...
    public class MenuViewController
    {
        ...
        MenuItem CreateMenuItem(string text, EventHandler click)
        {
...
//右键菜单
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                CreateMenuItem("显示主界面", new EventHandler(this.Config_Click)),
                ...
                CreateMenuGroup("Proxy rule", new MenuItem[] {
                    ...
                    new MenuItem("-"),
                    CreateMenuGroup("更新规则", new MenuItem[] {
                ...
                CreateMenuItem("充值", new EventHandler(this.payment)),
        ...
        {
            Process.Start("https://www.maile3.com");
        }
        ...
        {
            Process.Start("https://wiki.maile3.com");
        }

        private void FeedbackItem_Click(object sender, EventArgs e)
        {
            Process.Start("http://jiasu.maile3.com/contact.html");
        }
        ...
        {
            Process.Start("http://jiasu.maile3.com/about.html");
        }
